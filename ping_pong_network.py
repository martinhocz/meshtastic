...
meshtastic_ip = '192.168.15.10'  # Meshtastic IP adress
...
def get_node_info(ip_address, port):
    print("Initializing TCPInterface to get node info...")
    local = TCPInterface(ip_address, port)
...
def main():
    ...
    node_info = get_node_info(meshtastic_ip, meshtastic_port)
    ...
    local = TCPInterface(meshtastic_ip, meshtastic_port)
